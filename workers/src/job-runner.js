/**
 * Worker 2: Job Runner (Snehal Printers)
 ...
 * Supabase → leads (accessed in step handlers)
 */
...
// ═══════════════════════════════════════════════════════════════════════════
// STEP HANDLERS — Snehal Printers only runs the lead-gen + lead-email flows
// ═══════════════════════════════════════════════════════════════════════════

const STEP_HANDLERS = {

  // ── Lead Generation ─────────────────────────────────────────────────────
  lead_select_product:         (ctx) => leadSelectProduct(ctx),
  lead_tavily_find_companies:  (ctx) => leadTavilyFindCompanies(ctx),
