...
export const LEAD_GEN_STEPS = {
  lead_select_product:         'Selecting product angle',
  lead_tavily_find_companies:  'Searching for real companies',
...
export const LEAD_EMAIL_STEPS = {
  ...
  lead_email_draft_email: 'AI drafting follow-up email',
  lead_approval_gate:     'Sending for approval',
  lead_send_email:        'Sending follow-up email',
}
