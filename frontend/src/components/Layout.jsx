...
import {
  LayoutDashboard, Users, CheckSquare, History, LogOut, Menu, X, Bell, Activity, Printer
} from 'lucide-react'
    ...
    <div className="flex h-screen overflow-hidden bg-slate-100">
      ...
      `}>
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          ...
          <div>
            <div className="text-white font-semibold text-sm leading-tight">Snehal Printers</div>
            <div className="text-white/50 text-xs">Lead Workflows</div>
          </div>
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => signOut()} className="text-white/40 hover:text-white transition-colors" title="Sign out">
              <LogOut size={16} />
            </button>
          </div>
        </div>
